...
class SelfTestingFaceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_self_testing_face, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment SelfTestingFaceFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SelfTestingFaceFragment().apply {
